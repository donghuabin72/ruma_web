 ...
 */
OpenLayers.Control.NEOverviewMap = OpenLayers.Class(OpenLayers.Control.OverviewMap, {
    ...
    draw: function () {
        ...
        this.extentRectangle.style.zIndex = 2000; //HACK
        ...
        if (!this.outsideViewport) {
            ...
            // maximize button div
            var img = "../../" + imgLocation + 'common/overexpand.gif';
            ...
            // minimize button div
            var img = "../../" + imgLocation + 'common/overcontract.gif';
    ...
    CLASS_NAME: "OpenLayers.Control.NEOverviewMap"
});