OpenLayers.Control.LTOverviewMap = OpenLayers.Class(OpenLayers.Control.OverviewMap, {
    initialize: function (options) {
        ...
        options = OpenLayers.Util.extend({
            mapOptions: {
                ...
                displayProjection: new OpenLayers.Projection("EPSG:90013"),
                units: "degree",
                //maxResolution: 156543.0339,
                //maxExtent: new OpenLayers.Bounds(-20037508, -20037508, 20037508, 20037508)
                //maxResolution: 0.3515625,
                //maxExtent: new OpenLayers.Bounds(3, 54, 73, 136)
                maxExtent: new OpenLayers.Bounds(-90, 90, -180, 180)
            }
        }, options);
    ...
    setOvMapCenter: function () {
        ...
        //alert(this.map.getExtent().getCenterLonLat());
    },
    /*
     *更新地图范围到鹰眼图的图框
     */
