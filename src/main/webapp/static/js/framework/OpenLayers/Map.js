...
OpenLayers.Map = OpenLayers.Class({
  ...
  /********************************************************/
    ...
    zoomTo: function(zoom, xy) {
        ...
        var map = this;
/*       	if(zoom<8){// added by chencl 控制图层显示的比例尺
       		this.zoomTo(8);
    		return false;
    	}*/
        if (map.isValidZoomLevel(zoom)) {
            ...
            if (map.zoomTween) {
                ...
                if (map.zoomTween.playing && map.zoomTween.duration < 3 * map.zoomDuration) {
                	...
                	//modifyed by chencl 修正滚轮事件切换两个比例尺的异常
...
//                    };
                    ...
                    map.zoomTween.start(start, end, map.zoomDuration, {
                        minFrameRate: 50*3, // don't spend much time zooming
                        //added by chencl  添加*3,修正地图加载部分未被清除的问题
                        callbacks: {
