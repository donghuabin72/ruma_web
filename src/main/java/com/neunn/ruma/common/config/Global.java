 ...
 */
package com.neunn.ruma.common.config;
...
import com.neunn.ruma.utils.PropertiesLoader;
...
public class Global {
	 ...
	 * 属性文件加载对象
	 */
	private static PropertiesLoader loader = new PropertiesLoader("ruma.properties","message.properties");
