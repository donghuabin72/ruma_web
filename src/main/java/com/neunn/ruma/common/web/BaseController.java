...
import com.neunn.ruma.common.validator.BeanValidators;
...
public abstract class BaseController {
     ...
     */
    protected Map<String, Object> beanValidatorStr(Object object, Class<?>... groups) {
        ...
        try {
            ...
            list.add(0, "数据验证失败：");
            map.put("msg", addMessage(list.toArray(new String[] {})));
