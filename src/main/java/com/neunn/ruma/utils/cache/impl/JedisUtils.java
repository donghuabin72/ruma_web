...
import com.neunn.ruma.utils.cache.CacheInterface;
 ...
 * @since 1.0
 */
public class JedisUtils implements CacheInterface {
     ...
     * @return
     */
    public  String setExpireTime(String key, int cacheSeconds) {
        String result = null;
        Jedis jedis = null;
        try {
            jedis = getResource();
            ...
            logger.debug("setExpireTime {} = {}", key);
        } catch (Exception e) {
            logger.warn("setExpireTime {} = {}", key, e);
        } finally {
            returnResource(jedis);
        }
        return result;
